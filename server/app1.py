...
model = load_model('C:/Users/sreem/Downloads/client (1)/server/model1006qqqqqq.keras')

# Load the word-to-index and index-to-word mappings
with open('C:/Users/sreem/Downloads/client (1)/server/wordtoixqqqq.json', 'r') as f:
    wordtoix = json.load(f)

with open('C:/Users/sreem/Downloads/client (1)/server/ixtowordqqqq.json', 'r') as f:
